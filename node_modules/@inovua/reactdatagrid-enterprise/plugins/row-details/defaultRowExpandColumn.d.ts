...
declare const _default: {
    id: string;
    rowExpandColumn: boolean;
    cellSelectable: boolean;
    headerAlign: string;
    textAlign: string;
    render: ({ isRowExpandable, rowExpanded, toggleRowExpand, renderRowDetailsExpandIcon, renderRowDetailsCollapsedIcon, }: TypeRender) => React.FunctionComponentElement<{
        style: {
            cursor: string;
            position: string;
            top: number;
    ...
    header: ({ renderRowDetailsMoreIcon, }: {
        renderRowDetailsMoreIcon?: (() => void) | undefined;
    }) => void | JSX.Element;
